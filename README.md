...
> 🚀 一份写给 Git 新手的快速入门指南，带你从零开始掌握版本控制的核心技能。

## 目录

- [什么是版本控制](#什么是版本控制)
- [使用 Git 的三种形式](#使用-git-的三种形式)
- [Git 使用必要配置（⚠ 一定要配置 ⚠）](#git-使用必要配置一定要配置)
- [创建本地仓库](#创建本地仓库)
- [Git 基本操作](#git-基本操作)
  - [文件的三种状态](#文件的三种状态)
  - [状态间的转换](#状态间的转换)
  - [状态的查看（status）](#状态的查看status)
  - [查看提交日志（log）](#查看提交日志log)
  - [版本回退](#版本回退)
  - [忽略列表](#忽略列表)
- [Git 分支](#git-分支)
  - [什么是分支](#什么是分支)
  - [查看、创建本地分支（branch）](#查看创建本地分支branch)
  - [切换分支（checkout）](#切换分支checkout)
  - [合并分支（merge）](#合并分支merge)
- [Git 远程仓库](#git-远程仓库)
  - [配置公钥连接远程仓库](#配置公钥连接远程仓库)
  - [添加远程仓库](#添加远程仓库)
  - [推送本地分支到远程仓库（push）](#推送本地分支到远程仓库push)
  - [从远程仓库克隆（clone）](#从远程仓库克隆clone)
  - [从远程仓库抓取（fetch）和拉取（pull）](#从远程仓库抓取fetch和拉取pull)
